...
class Square:
    ...
    def __str__(self):
        """Preps a string to be printed by print() with the square filled with
        '#' characters, and precedes them with spaces (self.__position
        offset (x, y)). If self.__size is 0, then it returns an empty string.
        """
        string = ""
        if self.__size != 0:
