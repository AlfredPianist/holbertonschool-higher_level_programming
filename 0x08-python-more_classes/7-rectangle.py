...
and area and perimeter as public methods, as well as a string representation of
itself using the '#' character, a representation (Rectangle(width, height)) to
be evaluated by eval(), and a message printed when a Rectangle instance is
deleted.
"""
