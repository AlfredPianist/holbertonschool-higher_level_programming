...
setters and getters, and area and perimeter as public methods, as well as a
string representation of itself using the '#' character, a representation
(Rectangle(width, height)) to be evaluated by eval(), and a message printed
...
class Rectangle:
    ...
    def __del__(self):
        """Calls the garbage collector, and prints a message when an instance
